        ...
        <div className="relative z-10 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg font-medium leading-relaxed">
              &ldquo;The most reliable platform for modern logistics. CargoVista gives us the visibility we need to keep our fleet moving across the oceans.&rdquo;
            </p>
            <footer className="text-sm text-slate-400">
              Sofie Davis, Logistics Director
            </footer>
          </blockquote>
        </div>

        {/* Decorative Gradient Blob (To add depth) */}
